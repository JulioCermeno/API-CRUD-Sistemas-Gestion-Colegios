...
namespace Api_Web_Crud.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ProfesoresController(CrudApiWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Profesores != null ? 
                          ...
                          Problem("Entity set 'CrudApiWebContext.Profesores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProfesor,Nombre,Edad,Materia,AñosExperiencia")] Profesores profesore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProfesor,Nombre,Edad,Materia,AñosExperiencia")] Profesores profesore)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CrudApiWebContext.Profesores'  is null.");
            }
            var profesore = await _context.Profesores.FindAsync(id);
            if (profesore != null)
            {
